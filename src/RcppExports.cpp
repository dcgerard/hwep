...
RcppExport SEXP _hwep_sample_int(SEXP probsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _hwep_mod_postmat(SEXP postmatSEXP, SEXP glSEXP, SEXP qSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix& >::type postmat(postmatSEXP);
    Rcpp::traits::input_parameter< NumericMatrix& >::type gl(glSEXP);
    Rcpp::traits::input_parameter< NumericVector& >::type q(qSEXP);
    mod_postmat(postmat, gl, q);
    return R_NilValue;
END_RCPP
}
// gibbs_gl
...
RcppExport SEXP _rcpp_module_boot_stan_fit4gl_alt_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4gl_null_mod();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_stan_fit4gl_alt_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4gl_alt_mod, 0},
    {"_rcpp_module_boot_stan_fit4gl_null_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4gl_null_mod, 0},
    {NULL, NULL, 0}
};
