...
namespace model_gl_alt_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_gl_alt");
    reader.add_event(23, 21, "end", "model_gl_alt");
    return reader;
}
#include <stan_meta_header.hpp>
class model_gl_alt
  : public stan::model::model_base_crtp<model_gl_alt> {
private:
        int N;
        int K;
        matrix_d gl;
        vector_d beta;
public:
    model_gl_alt(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_gl_alt_namespace::model_gl_alt";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_gl_alt_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_gl_alt_namespace::model_gl_alt stan_model;
#ifndef USING_R
